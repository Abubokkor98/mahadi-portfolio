...
export default function GalleryPage() {
  ...
  return (
    <div className="min-h-screen py-8 sm:py-12 bg-muted/10">
                  ...
                  <div className="relative aspect-4/5 bg-muted overflow-hidden">
                    ...
                    {failedImages.has(photo.id) ? (
                      ...
                      <>
                        ...
                        />
                        {/* Overlay */}
                        <div className="absolute inset-0 bg-linear-to-t from-background/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
      ...
      >
        <DialogContent
          className="max-w-[95vw] max-h-[95vh] w-full h-full p-0 overflow-hidden bg-background/95 backdrop-blur-xl border-none"
          ...
          {selectedPhoto && (
            ...
            >
              ...
              <Button
                variant="ghost"
                size="icon"
                className="absolute top-4 right-4 z-50 bg-foreground/10 hover:bg-foreground/20 text-foreground rounded-full backdrop-blur-md transition-all"
                onClick={() => {
                  setSelectedPhoto(null);
                  setIsZoomed(false);
                }}
              ...
              {/* Photo Counter */}
              <div className="absolute top-4 left-4 z-50 bg-foreground/10 backdrop-blur-md px-4 py-2 rounded-full text-foreground text-sm font-medium">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="absolute top-4 right-20 z-50 bg-foreground/10 hover:bg-foreground/20 text-foreground rounded-full backdrop-blur-md transition-all"
              ...
              <Button
                variant="ghost"
                size="icon"
                className="absolute left-4 top-1/2 -translate-y-1/2 z-40 bg-foreground/10 hover:bg-foreground/20 text-foreground rounded-full backdrop-blur-md h-12 w-12 transition-all hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <Button
                variant="ghost"
                size="icon"
                className="absolute right-4 top-1/2 -translate-y-1/2 z-40 bg-foreground/10 hover:bg-foreground/20 text-foreground rounded-full backdrop-blur-md h-12 w-12 transition-all hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              {/* Info Overlay - Bottom */}
              <div className="absolute bottom-0 left-0 right-0 z-40 bg-linear-to-t from-background/90 via-background/60 to-transparent backdrop-blur-sm p-6 sm:p-8">
                <div className="max-w-4xl mx-auto space-y-3">
                  <div className="flex items-center gap-3 flex-wrap">
                    <Badge
                      variant="secondary"
                      className="bg-foreground/10 text-foreground border-foreground/10 capitalize backdrop-blur-md"
                    >
                  ...
                  <p className="text-muted-foreground text-xs sm:text-sm hidden sm:block">
                    Use{" "}
                    <kbd className="px-2 py-1 bg-foreground/10 rounded text-muted-foreground">
                      ←
                    </kbd>{" "}
                    <kbd className="px-2 py-1 bg-foreground/10 rounded text-muted-foreground">
                      →
